...
import 'package:fresh_cart/core/util/widget/custom_snackbar.dart';
...
class _ResetPasswordScreenState extends State<ResetPasswordScreen>
    ...
    return Scaffold(
      body: BlocListener<AccountBloc, AccountState>(
        listener: (ctx, state) {
          ...
          _loading.value =
              state.status == AccountStatus.sendingResetInstruction;
          ...
          if (state.status == AccountStatus.resetInstructionSent) {
  ...
  void _sendInstruction() {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<AccountBloc>().add(ResetPassword(email: _email));
    }
  }
}
